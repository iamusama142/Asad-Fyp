                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="{{$url}}" method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="Commate_Heade" name="Commate_Member_name" value="{{old('Commate_Member_name')}}" placeholder="Committee Member Name">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="Commate_Heade1" value="{{old('Committee_Desigination')}}" name="Committee_Desigination" placeholder="Committee Member Desigination">
                                                <span class="text-danger">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <textarea class="form-control" id="Commate_Desc" name="com_datails" placeholder="Commate Member Datail"> {{old('com_datails')}}</textarea>
                                                <span class="text-danger">
                                                    @error('com_datails')
                                                        {{ $message }}
                                                    @enderror
