                                    ...
                                    <ul>
                                        <li class="notification-unread">
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="res/images/avatar/1.jpg"
                                                    alt="">
                                        ...
                                        <li class="notification-unread">
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="res/images/avatar/2.jpg"
                                                    alt="">
                                                <div class="notification-content">
                                        ...
                                        <li>
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="res/images/avatar/3.jpg"
                                                    alt="">
                                                <div class="notification-content">
                                        ...
                                        <li>
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="res/images/avatar/4.jpg"
                                                    alt="">
                                                <div class="notification-content">
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            ...
                                            <a href="/teacher/status/{{$notification->data['id']}}/1">
                                                ...
                                                <div class="notification-content">
                                                    <h6 class="notification-heading">{{ $notification->notifiable_id}}{{$notification->data['heading']}}</h6>
                            ...
                            <div class="drop-down dropdown-profile animated fadeIn dropdown-menu">
                                <div class="dropdown-content-body">
                                    <ul>
                                        ...
                                        <hr class="my-2">
                                        <li>
                                            <a href="page-lock"><i class="icon-lock"></i> <span>Lock
                                                    Screen</span></a>
                                        </li> --}}
