                                ...
                                <div class="form-validation">
                                    <form class="form-valide" action="#" method="post">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label" for="Student-Name">Student Name <span class="text-danger">*</span>
                                            </label>
                                            <div class="col-lg-6">
                                                <input type="text" class="form-control" id="Student-Name" name="val-username" placeholder="Enter Student Name..">
                                            </div>
                                        </div>
                                        <div class="form-group row">
